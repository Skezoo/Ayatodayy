const verses = [
    ...
    // 100+ المزيد من الآيات هنا...
    { text: "طُوبَى لِصَانِعِي السَّلاَمِ، لِأَنَّهُمْ يُدْعَوْنَ أَبْنَاءَ اللّهِ", reference: "متى 5:9", explanation: "المباركون هم صانعو السلام" },
    { text: "إِنَّ الْمُحِبَّ لَا يَحْسِدُ لَا يَفْتَخِرُ وَلَا يَتَكَبَّرُ", reference: "1 كورنثوس 13:4", explanation: "الطبيعة الحقيقية للمحبة" },
    { text: "إِنْ لَمْ تَحِبُّونَ فِي قُلُوبِكُمْ، فَلا تَكُونُوا فِي التَّفَاضُلِ", reference: "يوحنا 15:4", explanation: "الفرق بين المحبة والأنانية" },
    { text: "وَالَّذِينَ يَحْبُونَ غَيْرَهُمْ لَا يَكُونُونَ فِي قُوَّةِ أَحْبَابِهِمْ", reference: "متى 22:39", explanation: "محبة الآخرين تعني قربهم منا" },
    { text: "أَنْتَ تَقُولُ: إِذَا رَأَيْتَ أَخَاكَ يَفْعَلُ السَّيِّئَاتِ فَقُلْ لَهُ: احْتَسِي لِي", reference: "متى 18:15", explanation: "التشجيع على المحبة" },
    // 150 آية كاملة...
];
...
function updateVerseDisplay() {
    ...
    }, 500); // التأخير للتأكد من تحميل الآية
}
